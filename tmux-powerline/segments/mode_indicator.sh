...
run_segment() {
  ...
  prefix_text_color="#[fg=${TMUX_POWERLINE_SEG_MODE_INDICATOR_PREFIX_MODE_TEXT_COLOR} bold]"
  ...
  # Separator.
  separator="#[fg=$TMUX_POWERLINE_CUR_SEGMENT_FG bg=${TMUX_POWERLINE_SEG_MODE_INDICATOR_SUSPEND_MODE_BG_COLOR:-$TMUX_POWERLINE_CUR_SEGMENT_BG}]$TMUX_POWERLINE_SEG_MODE_INDICATOR_SEPARATOR_TEXT"
